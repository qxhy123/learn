// 组装「英语」课程：_build/eng/uNcK.json → public/courses/english/{course.json,units/uN.json}
// 用法：node _build/assemble-eng.mjs   （英语 agent 直接产出 JSON，避开 TS 单引号撇号转义问题）
...
const SRC = path.join(ROOT, '_build/eng')
const OUT = path.join(ROOT, 'public/courses/english')

// 8 单元元信息（每 part 一个单元，各 4 章）
const UNITS = [
  { id: 'u1', n: 4, title: '语音与词汇基础', color: '#58cc02', icon: '🔤', blurb: '字母·音标·构词法·句子基础' },
  { id: 'u2', n: 4, title: '词性精讲',       color: '#1cb0f6', icon: '🏷️', blurb: '名词冠词·代词形容词·动词副词·介词连词' },
  { id: 'u3', n: 4, title: '时态体系',       color: '#ce82ff', icon: '⏳', blurb: '一般·进行·完成·完成进行时' },
  { id: 'u4', n: 4, title: '句型与语法进阶', color: '#ff9600', icon: '🧱', blurb: '简单并列复合句·从句·被动·虚拟语气' },
  { id: 'u5', n: 4, title: '阅读理解',       color: '#ff4b4b', icon: '📖', blurb: '阅读策略·语境词义·批判阅读·学术文学' },
  { id: 'u6', n: 4, title: '写作精通',       color: '#0d9488', icon: '✍️', blurb: '段落·文体·学术写作·商务写作' },
  { id: 'u7', n: 4, title: '口语与听力',     color: '#9333ea', icon: '🗣️', blurb: '发音语调·日常会话·演讲·辩论' },
  { id: 'u8', n: 4, title: '高阶精通',       color: '#db2777', icon: '🎓', blurb: '习语短语动词·修辞·跨文化·考试策略' },
]
...
async function main() {
  ...
  for (const u of UNITS) {
    ...
    manifestUnits.push({ id: u.id, title: u.title, color: u.color, icon: u.icon, blurb: u.blurb, file: `courses/english/units/${u.id}.json` })
  }
  ...
  const manifest = {
    ...
    subtitle: '像闯关一样学英语',
    brandMark: 'Ab',
    brandName: 'English Quest',
    color: '#16a34a',
    source: '来自《英语从零到高阶完全教程》',
    figureBase: 'courses/english/figures/',
    inputHint: "答案不区分大小写；填写英文单词或短语即可",
