...
本章按系统层次组织题库：27.1 建立基础认知，27.2 回到底层资源，27.3 和 27.4 覆盖训练与制品，27.5 和 27.6 覆盖推理与平台调度，27.7 覆盖治理，27.8 用综合 case 把前面内容串起来。核心结论很简单：AI Infra interviews test system judgment, not memorized component names。
...
- **自测复盘**：每节统计不会的题，把薄弱点映射回正文章节。例如 27.5 卡住，就回读第14-16章；27.6 卡住，就回读第18-20章。
