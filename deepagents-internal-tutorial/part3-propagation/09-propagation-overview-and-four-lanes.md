...
- 后续章节：[第10章：Callbacks、Config 与 Callback Manager](./10-callbacks-config-and-callback-manager.md)、[第11章：Streaming、Visibility 与 Selective Exposure](./11-streaming-visibility-and-selective-exposure.md)、[第12章：Subagent 传播矩阵与维护者 recipes](./12-subagent-propagation-matrix-and-maintainer-recipes.md)、[附录 D：传播与可见性速查表](../appendix/propagation-and-visibility-cheatsheet.md)
