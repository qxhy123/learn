...
| `Execution` | tool、subagent、graph runtime、checkpoint、interrupt 是怎么跑起来的 | [第4章](./part2-core-runtime/04-filesystem-and-state-model.md)、[第5章](./part2-core-runtime/05-tools-as-runtime-surface.md)、[第7章](./part2-core-runtime/07-subagents-and-context-isolation.md)、[第8章](./part2-core-runtime/08-summarization-permissions-and-safety-boundaries.md) |
| `Propagation` | callbacks、config、messages、stream events 究竟沿哪条线传播 | [第9章](./part3-propagation/09-propagation-overview-and-four-lanes.md)、[第10章](./part3-propagation/10-callbacks-config-and-callback-manager.md)、[第11章](./part3-propagation/11-streaming-visibility-and-selective-exposure.md)、[第12章](./part3-propagation/12-subagent-propagation-matrix-and-maintainer-recipes.md)、[附录 D](./appendix/propagation-and-visibility-cheatsheet.md) |
...
- [第5章：Tools 作为 Runtime Surface](./part2-core-runtime/05-tools-as-runtime-surface.md)
- [第6章：Memory、Skills、Prompt Layering 与 Config 传播](./part2-core-runtime/06-memory-skills-and-system-prompt-layering.md)
- [第7章：Subagents、任务交接与上下文隔离](./part2-core-runtime/07-subagents-and-context-isolation.md)
- [第8章：Summarization、Permissions 与安全边界](./part2-core-runtime/08-summarization-permissions-and-safety-boundaries.md)

### Part 3：传播、可见性与观测

- [第9章：传播层总览与四条线](./part3-propagation/09-propagation-overview-and-four-lanes.md)
- [第10章：Callbacks、Config 与 Callback Manager](./part3-propagation/10-callbacks-config-and-callback-manager.md)
- [第11章：Streaming、Visibility 与 Selective Exposure](./part3-propagation/11-streaming-visibility-and-selective-exposure.md)
- [第12章：Subagent 传播矩阵与维护者 recipes](./part3-propagation/12-subagent-propagation-matrix-and-maintainer-recipes.md)
...
| 排 callback / config / stream 可见性问题 | [第9章](./part3-propagation/09-propagation-overview-and-four-lanes.md)、[第10章](./part3-propagation/10-callbacks-config-and-callback-manager.md)、[第11章](./part3-propagation/11-streaming-visibility-and-selective-exposure.md)、[第12章](./part3-propagation/12-subagent-propagation-matrix-and-maintainer-recipes.md)、[附录 D](./appendix/propagation-and-visibility-cheatsheet.md) | 明确传播链和观测点 |
...
- subagent 的事件为什么外层能看到，但父级 middleware 不一定能拦截：可见性和拦截边界不是同一个问题；先读 [第7章](./part2-core-runtime/07-subagents-and-context-isolation.md)、[第11章](./part3-propagation/11-streaming-visibility-and-selective-exposure.md) 与 [第12章](./part3-propagation/12-subagent-propagation-matrix-and-maintainer-recipes.md)。
- callback / config 传播异常该先查哪层：先确认入口点在 `langchain_core` 还是 `langgraph`，再回看 Deep Agents 是否只是在透传或加策略；详见 [第9章](./part3-propagation/09-propagation-overview-and-four-lanes.md) 与 [第10章](./part3-propagation/10-callbacks-config-and-callback-manager.md)。
