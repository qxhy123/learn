...
- A 公式表 1179 行（Part 1-13 全公式 + 易错提醒）
- B 模型图集 1123 行（24 个核心模型 + 高三专属新方法表）
- C 80 题（种子）+ D 100 题（中档）+ E 60 题 = **总 240 题题库**
- F-seed 1483 行（C 80 题详解）
- F1 1196 行 / F2 1647 行 / F3 2100 行 / F4 1243 行 = **D + E 共 160 题详解**

合计 10 个 appendix 文件，覆盖 240 题完整详解。
