...
- **练习驱动学习**：全书 28 章，每章末配 8 道**章内练习/自测**（共 224 道）均附详细答案；另在附录设有独立的**附录题库**（C/D/E 三档共 240 题，配 7 个 F 详解文件）
...
> **注**：第一部分（预备知识）与第二部分（极限与连续）均自"第 4 章"起编号，存在章号重复；跨部分引用时请带上 Part 名（如"第二部分 第 4 章 数列极限"）以避免歧义。
...
| 附录 | 标题 | 内容说明 |
|------|------|----------|
| 附录A | [公式速查表](./appendix/A-formula-sheet.md) | 导数、积分、级数、向量分析、矩阵微积分、概率积分公式 |
| 附录B | [模型图谱](./appendix/B-model-atlas.md) | 核心概念、定理与模型之间关系的全局图谱 |
| 附录C | [基础练习 80 题](./appendix/C-exercises-basic.md) | 附录题库基础档：覆盖各部分基本概念与运算 |
| 附录D | [中档练习 100 题](./appendix/D-exercises-medium.md) | 附录题库中档：综合计算与方法运用 |
| 附录E | [挑战练习 60 题](./appendix/E-exercises-advanced.md) | 附录题库挑战档：证明、技巧与跨章综合 |
| 附录F1a | [题库详解：极限](./appendix/F1a-solutions-limits.md) | 极限与连续主题题目的完整解析 |
| 附录F1b | [题库详解：微分](./appendix/F1b-solutions-differentiation.md) | 微分学主题题目的完整解析 |
| 附录F2a | [题库详解：积分](./appendix/F2a-solutions-integration.md) | 积分学主题题目的完整解析 |
| 附录F2b | [题库详解：级数](./appendix/F2b-solutions-series.md) | 无穷级数主题题目的完整解析 |
| 附录F3a | [题库详解：多元微积分](./appendix/F3a-solutions-multivar.md) | 多元微积分主题题目的完整解析 |
| 附录F3b | [题库详解：常微分方程](./appendix/F3b-solutions-ode.md) | 常微分方程主题题目的完整解析 |
| 附录F4 | [题库详解：AI 微积分](./appendix/F4-solutions-ai-calculus.md) | AI 微积分扩展主题题目的完整解析 |
| 附录 | [符号说明](./appendix/notation-guide.md) | 全书使用的数学符号与 AI 常用记号 |
...
- **224 道章内练习 + 240 题附录题库**：每章末统一 8 题章内练习/自测（28 × 8 = 224 道）均配详细解答；附录另设独立题库（基础 80 + 中档 100 + 挑战 60 = 240 题，配 7 个 F 详解文件）
...
### 新增附录题库（240 题 C/D/E 三档）

`appendix/` 新增**附录题库**：基础 C 80 + 中档 D 100 + 挑战 E 60 = 240 题，按 4 大主题分为 7 个 F 详解文件（F1a 极限 / F1b 微分 / F2a 积分 / F2b 级数 / F3a 多元 / F3b ODE / F4 AI 微积分）。

> 注意：附录题库（240 题）与正文**章内练习/自测**（28 章 × 8 题 = 224 道，附于各章末尾并配套答案）是两套独立的练习体系，请勿混淆。
