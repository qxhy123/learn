...
\draw[-Stealth, very thick, gray!60]
  ...
  node[midway, above, font=\scriptsize] {Slutsky};

% --- Right panel: X_n + Y_n ->_d X + c (shifted distribution) ---
\begin{axis}[
  name=ax3,
  at={(ax2.east)}, anchor=west, xshift=1.4cm,
  width=6cm, height=5.5cm,
  xmin=-3, xmax=7,
  ymin=0, ymax=0.50,
  xlabel={$x$},
...
% Slutsky theorem title at bottom
\node[font=\large\bfseries] at ($(ax1.north)!0.5!(ax3.north)+(0,0.5cm)$)
