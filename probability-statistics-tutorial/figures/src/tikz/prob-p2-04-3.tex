...
\begin{tikzpicture}
  ...
  % Fulcrum triangle at E[X]=3 — drawn below deepest bar (x=3 bar goes to -3.2)
  \fill[red!80] (3,-3.5) -- (2.6,-4.1) -- (3.4,-4.1) -- cycle;
  \node[font=\small,red,below] at (3,-4.15) {$E[X]=3$};
  ...
  \node[font=\small,fill=yellow!20,draw,rounded corners=2pt,align=center]
    at (3,2.2) {$E[X]=\sum_i x_i\,p(x_i)$\\$=1(0.1)+2(0.2)+3(0.4)+4(0.2)+5(0.1)=3$};

  % Title
  \node[font=\small\bfseries] at (3,3.2) {期望的几何意义：概率加权平衡点};
