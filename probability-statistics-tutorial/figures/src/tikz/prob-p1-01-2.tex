...
\begin{tikzpicture}[scale=1.0]
  ...
  % Leader line: label outside circle/square, well below Omega label
  \node[font=\scriptsize,blue!80,anchor=north west] (rptlbl) at (3.8,0.1) {random pt};
  \draw[->,blue!70,thin] (3.78,0.18) -- (2.58,0.28);
